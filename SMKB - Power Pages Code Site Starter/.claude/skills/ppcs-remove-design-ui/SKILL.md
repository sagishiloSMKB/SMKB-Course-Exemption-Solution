...
Decide this at **Init Project Step 8**, when the specs are known — "does this site use the SMKB
...
- This is a **one-way door for this solution**: re-adding the design system later means restoring
  `.npmrc`, the dependency, `createSmkb()` and the CSS imports. Decide at Step 8.
